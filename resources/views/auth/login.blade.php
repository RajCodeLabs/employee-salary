<x-layout>
    <div class="max-w-md">
        <h1 class="text-center uppercase font-semibold text-4xl mb-2"> Log In </h1>
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action={{ route('signin') }}>
            @csrf
            <div class="mb-4">
